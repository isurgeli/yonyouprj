 ...
 * @author：
 */
public class OrderVO extends AggregatedValueObject implements IBillAction,IscmDefCheckVO{
 ...
 * 获取修改前旧VO
 */
public OrderVO getM_voOld() {
  return m_voOld;
}
/**
 * 设置修改前旧VO
 */
public void setM_voOld(OrderVO old) {
  m_voOld = old;
}
/**
 * 功能描述：得到该单据的操作状态
