...
public enum GZCGReportAnalysisConst implements ISQLSection{
	...
	INVDOC("INVDOC",
					"存货",
					new String[]{"vinvdoccode", "vinvdocname", "vinvspec"},
					new String[]{"bd_invbasdoc.invcode", "bd_invbasdoc.invname", "nvl(bd_invbasdoc.invspec,'-')"},
					new String[]{"bd_invbasdoc", "bd_invmandoc"},
					new String[]{" and gzcg_qcrp_checkbill_v.cmangid = bd_invmandoc.pk_invmandoc and bd_invmandoc.pk_invbasdoc = bd_invbasdoc.pk_invbasdoc "}),
	MONTH			("MONTH",
					"月度",
					new String[]{"vmonth"},
