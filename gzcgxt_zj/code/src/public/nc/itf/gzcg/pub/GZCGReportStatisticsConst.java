...
public enum GZCGReportStatisticsConst implements ISQLSection{
	...
	SEMIPRODUCTPUBLIC ("PUBLIC",
			...
			new String[]{"qc_cghzbg_b.ypname", "qc_cghzbg_b.zdy5", "qc_cghzbg_b.jcpici", "'-'"},
			new String[]{"qc_cghzbg_b"},
			new String[]{" and qc_cghzbg_b.pk_cghzbg_h = gzcg_qcrp_checkbill_v.pk_cghzbg_h"}),
